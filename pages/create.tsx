      ...
      <GridItemEight className="space-y-5">
        ...
        <div className="w-11/12 pt-6 flex flex-col gap-4 ml-4">
          <div className='w-full flex flex-col gap-1'>
            ...
            <input
              className="w-full text-sm rounded-lg px-4 py-2 hover:bg-slate-100 border-purple-200 border-solid border-2 bg-slate-50 text-gray-900 font-medium focus:ring-0 outline-none focus:border-purple-600"
              id="title"
              type="text"
          ...
          <div className='w-full flex flex-col gap-1'>
            ...
            <textarea
              className="w-full text-sm rounded-lg px-4 py-2 hover:bg-slate-100 border-purple-200 border-solid border-2 bg-slate-50 text-gray-900 font-medium focus:ring-0 outline-none resize-none focus:border-purple-600" 
              rows={4}
              id="description"
          ...
          <div className='w-full flex flex-col gap-1'>
            ...
            <input
              ...
              multiple
              className={clsx({
                "file:bg-slate-50 file:text-purple-500 hover:file:bg-slate-100": true,
              ...
              })+" w-full text-sm rounded-lg px-4 py-2 hover:bg-slate-100 border-purple-200 border-solid border-2 bg-slate-50 text-gray-900 font-medium focus:ring-0 outline-none resize-none focus:border-purple-600"}
            />
          </div>
          ...
          <div className='w-full flex flex-col gap-1'>
            <Web3Button
              className="px-4 py-2 hover:bg-purple-600 border-purple-600 border bg-purple-500 text-white text-sm font-semibold focus:ring-0"
